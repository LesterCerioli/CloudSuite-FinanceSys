...
using FinanceBankSys.Core.Services;
using FinanceBankSys.Core.Services.Account;
using FinanceBankSys.Core.Services.Shop;
using FinanceBankSys.Server.Authorization;
using FinanceBankSys.Server.Authorization.Requirements;
using FinanceBankSys.Server.Configuration;
using FinanceBankSys.Server.Services;
using FinanceBankSys.Server.Services.Email;
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.DocumentTitle = "Swagger UI - FinanceBankSys";
